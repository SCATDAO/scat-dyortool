export default {
    ...
    return {
      ...
      questionList: [
        ...
        },
        {
          ...
          question:
            "Does their Telegram appear to have an active environment?",
          worksteps: [
            ...
            "B. Comment on activity in box below."
          ],
          example: "example",
          options: [
            { id: 1, name: "Yes", value: 1.0 },
  ...
  methods: {
    ...
    changeAnswerQuestion(answer) {
      ...
      console.log(JSON.stringify(this.currentQuestion[0].options))
