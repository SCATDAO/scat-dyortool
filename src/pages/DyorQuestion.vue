      ...
      <div class="css-work-quest-wrap">
        <div class="css-work-quest-top">
          <div
            ...
            :key="item"
            :class="{ active: isTextAreaInvisible }"
        ...
        <div
          ...
          :key="item"
        >
          <template v-if="isTextAreaInvisible">
            <div class="css-work-quest-suggest">Select an option</div>
          </template>

          <div
            class="css-work-quest-iwt"
            :class="{ active: isTextAreaInvisible }"
          >
...
export default {
  ...
  methods: {
    ...
    invisibleTextArea() {
      this.isTextAreaInvisible = !this.isTextAreaInvisible;
    },
    knowTextareaLength() {
